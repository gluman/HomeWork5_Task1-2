...
def add_doc(num_doc, type_doc, name_owner, num_shelf):
...
##############################################################
# Попробовал заложить обработку выполнения команд (функций). Новерное мой подход не совсем верный, думаю, что нужно обработку выполнения функции заложить в самой функции, а выполнеине команды (if add_doc(...) оставить в этом условии. не хватает знаний в best practics.

run = True
while run:
    command = input('Введите команду (h или help - справка) -> ')
    ...
    ''')
    ...
    elif command == 'people' or command == 'p':
        num_doc = input('Введите номер документа: ')
        if show_owner(num_doc):
            print('...Выполнено.')
        else:
        ...
        num_doc = input('Введите номер документа: ')
        if show_shelf(num_doc):
            print('..Выполнено.')
        else:
            print('Документ не найден, полка не найдена!')
        ...
        if add_doc(num_doc, type_doc, name_owner, num_shelf):
        ...
        if move_doc(num_doc, num_shelf):
            print('..Выполнено.')
        else:
            print('- Ошибка!')

    elif command == 'show shelfs' or command == 'ss':
        if show_shelfs():
            print('..Выполнено.')
        else:
            print('- Ошибка!')
        ...
        print('Командра не распознана. help - вывод команд, quit - выход.')

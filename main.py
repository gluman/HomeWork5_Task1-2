...
# ############################################################# Попробовал заложить обработку выполнения команд (
# функций). Новерное мой подход не совсем верный, думаю, что нужно обработку выполнения функции заложить в самой
# функции, а выполнеине команды (if add_doc(...) оставить в этом условии. не хватает знаний в best practics.
